...
* 概要
# 本文(見出しも設定する)
今さらながらYouTubeにハマっている。英語だとさらにディープなコンテンツがたくさんあって面白い。映画などと違って短いので、全然わからなくなることが少ない(ただ字幕の質は落ちる)。英語学習に向いていると感じる。そのなかでも自分が興味を持っていて面白かったコンテンツを列挙する。
