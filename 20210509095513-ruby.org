...
- Rubyは[[id:656a0aa4-e5d3-416f-82d5-f909558d0639][C language]]で用いられるLex字句解析ツールは使用しない。パフォーマンス、特殊なルールが必要だったために字句解析のコードを自前で用意している。
- 字句解析->構文解析。構文解析の段階でシンタックスチェックを行う
