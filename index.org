...
** TODO ファイルテーブルを作り直す
:LOGBOOK:
CLOCK: [2021-12-28 Tue 23:02]--[2021-12-29 Wed 02:02] =>  3:00
:END:
DBから被リンク数が取れるので、それも表示する。
...
#+end_src
** DONE コマンド整理
CLOSED: [2021-12-29 Wed 02:00]
:LOGBOOK:
CLOCK: [2021-12-28 Tue 18:38]--[2021-12-28 Tue 19:30] =>  0:52
:END:
ディレクトリ作ってそこに入れた。
