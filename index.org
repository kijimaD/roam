...
#+begin_src bash :results table
  ...
  echo `date --date '1 day ago' "+%Y-%m-%d"` `git whatchanged --diff-filter=A --since="1 days ago" --until="0 days ago"--format=oneline --name-only --pretty=format: | grep -e ".*org" | sort -u | wc -l`
  echo `date --date '2 day ago' "+%Y-%m-%d"` `git whatchanged --diff-filter=A --since="2 days ago" --until="1 days ago"--format=oneline --name-only --pretty=format: | grep -e ".*org" | sort -u | wc -l`
  echo `date --date '3 day ago' "+%Y-%m-%d"` `git whatchanged --diff-filter=A --since="3 days ago" --until="2 days ago"--format=oneline --name-only --pretty=format: | grep -e ".*org" | sort -u | wc -l`
  echo `date --date '4 day ago' "+%Y-%m-%d"` `git whatchanged --diff-filter=A --since="4 days ago" --until="3 days ago"--format=oneline --name-only --pretty=format: | grep -e ".*org" | sort -u | wc -l`
  echo `date --date '5 day ago' "+%Y-%m-%d"` `git whatchanged --diff-filter=A --since="5 days ago" --until="4 days ago"--format=oneline --name-only --pretty=format: | grep -e ".*org" | sort -u | wc -l`
  echo `date --date '6 day ago' "+%Y-%m-%d"` `git whatchanged --diff-filter=A --since="6 days ago" --until="5 days ago"--format=oneline --name-only --pretty=format: | grep -e ".*org" | sort -u | wc -l`
  echo `date --date '7 day ago' "+%Y-%m-%d"` `git whatchanged --diff-filter=A --since="7 days ago" --until="6 days ago"--format=oneline --name-only --pretty=format: | grep -e ".*org" | sort -u | wc -l`
  echo
...
#+RESULTS:
#+begin_src
Built with: GNU Emacs 29.1 (build 1, x86_64-pc-linux-gnu, GTK+ Version 3.24.37, cairo version 1.16.0)
#+end_src
