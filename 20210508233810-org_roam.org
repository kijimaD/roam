...
* References
- System CraftersのOrg Roam紹介。 :: [[https://www.youtube.com/watch?v=AyhPmypHDEw][Getting Started with Org Roam - Build a Second Brain in Emacs - YouTube]]
- [[https://www.mhatta.org/wp/2021/02/20/org-mode-101-9/#org125e180][日本語での紹介記事 :: Org mode 教室 その9: org-roam でアイデアをひねり出す]]
- 作者サイトのマニュアル。 :: https://blog.jethro.dev/posts/introducing_org_roam/
- org-modeのワークフロー。 :: https://blog.jethro.dev/posts/org_mode_workflow_preview/
* Archives
** CLOSE Unify workflow management with roam
CLOSED: [2021-09-04 土 12:42]
https://d12frosted.io/posts/2021-01-16-task-management-with-roam-vol5.html
** CLOSE CI, sqliteを入れて試してみる
CLOSED: [2021-09-04 土 12:07]
- search emacsql
Default install sqlite on ubuntu, so does not matter.
** DONE 基本的キーバインド
CLOSED: [2021-08-29 日 21:18]
 - find(C-c n f)
 - バックリンク(C-c n l)
 - Roamリンク挿入(C-c n i)補完を有効にすることであまり使わなくなる。
** DONE idリンクをpublishできない問題
CLOSED: [2021-08-29 日 19:53]
...
#+end_src
** DONE 外部リンクをグラフに表示し￼たくない
CLOSED: [2021-09-01 水 10:30]
