...
interfaceの拡張性が高い。interfaceを使った方がよさそう。
...
** [[http://typescript.ninja/typescript-in-definitelyland/][Revised Revised 型の国のTypeScript | Revised Revised TypeScript in Definitelyland]]
** [[https://typescript-jp.gitbook.io/deep-dive/][TypeScript Deep Dive 日本語版について - TypeScript Deep Dive 日本語版]]
ドキュメント。
** [[https://future-architect.github.io/typescript-guide/index.html][仕事ですぐに使えるTypeScript — 仕事ですぐに使えるTypeScript ドキュメント]]
ドキュメント。
* Archives
** DONE lspをセットする
