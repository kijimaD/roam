...
- TestStdErrorHander
** TODO [[https://zenn.dev/hsaki/books/golang-io-package][Goから学ぶI/O]]
:LOGBOOK:
...
- ネットワークもI/Oと捉えられる。コネクションからデータを読み取る・書き込むといえるから
