...
# すべてのコメントを削除した。
* 概要
POSTリクエストは成功するのに、GETリクエストがCORSエラーとなる状態になった。デベロッパーツールを見るとCORSエラーが出ていた。本当の原因は、ログインしてトークンをAuthorizationヘッダーにつけていたことだった。すぐAccess-Control-Allow-Headersを返すようにして解決したが、知らなかったので調べる。
...
* 関連
- [[id:20240212T234008][KDOC 91: 『世界一流エンジニアの思考法』を読んだ]]。を読んで考えた
