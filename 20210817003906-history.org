...
* 年表
** 2022年
- 開発環境のdocker-composeの整備を行い、全開発をDocker上で行えるようにした。(業務)
- 1月度のMVPを受賞した。(業務)
- 本番環境に準拠する[[id:1658782a-d331-464b-9fd7-1f8233b8b7f8][Docker]]イメージを作成し、CIテストを本番環境に近い形で行えるようにした。(業務)
- [[id:b4f456cf-d250-4877-ac4c-4b03144392f0][GraphQL]]をAPI開発に導入した。(業務)
- 本静的ページの全開発環境・デプロイを[[id:1658782a-d331-464b-9fd7-1f8233b8b7f8][Docker]]コンテナで行うようにした(ビルドが[[id:1ad8c3d5-97ba-4905-be11-e6f2626127ad][Emacs]], [[id:cfd092c4-1bb2-43d3-88b1-9f647809e546][Ruby]], [[id:a6c9c9ad-d9b1-4e13-8992-75d8590e464c][Python]], sqliteに依存する)。
** 2021年
