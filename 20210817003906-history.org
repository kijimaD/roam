...
キャリアは、「職種 x 専門領域」で表現できると考えている。どの山に登るかと、どの峰を目指すか。

職種。だいたい決まっている。

- ~MUST~ プログラマー
  - 数年間実際に手を動かして開発してきて、楽しさ、やりがいを感じるから
  - プライベートでの趣味を相互に活かせるから。何かを作るのが好きである
- ~SHOULD~ バックエンドプログラマー(が、必要であれば何でも学ぶ)
  - 今までバックエンドをやってきて経験と実績がある。安定して価値を提供できる可能性が高い
  - 逆にフロントエンド: 過去実際にやってみて、外観へのこだわりや興味があまりないと感じる(やってと言われたらやる)

専門領域。まだ曖昧である。

- ~MUST~ 専門領域の形「T型」

  まだ専門領域の位置は決まっていないが、形状は決まっている。専門領域の広さを持ったうえで、そのなかで1つコアな(興味と実績のもっともある)分野を持ったプログラマになりたい。
...
という感じで幅優先の探索になるだろうと考えている。キャリアの全体観の中で、今の段階はまだ<1>である。
...
- ~MUST~ 会社として優れた技術力がある
  - 優れた人や熱意のある人と働きたい
  - 熱意や優秀さは伝播していくと考えている。経験的に、ともに働くメンバーが自分の成長に大きく影響をもたらすと考えている

業界およびプロダクト。

- ~SHOULD~ コンピュータ資源や開発技術が商材となる業界や会社
  - もっとも興味があり、実際に多くの時間をかけているのがコンピュータである。今まではそういう観点がなかった
  - ビジネスに興味を持ちやすく、自分ごととして理解しやすい
  - バックエンド開発以外にも、専門的な仕事ができる可能性がある。少なくとも社内でお近づきになれる
  - チームレンタルとしての技術サービス提供、も含む
  - 受託での新規開発の経験をして、顧客と新しいものを作っていく体験はよかったと感じた。自社プロダクトの会社と比較して、新しめの技術経験や設計を行いやすいのを好ましく考えている
