...
職業キャリアは、「職種 x 専門領域」で表現できると考えている。どの山に登るかと、どの峰を目指すか。
...
という感じで幅優先の探索になるだろうと考えている。詳細に計画できるものだとはみなしていない。キャリアの全体観の中で、今の段階はまだ<1>である。
...
- ~SHOULD~ コンピュータ資源や開発技術が商材となる業界や会社
  ...
  - バックエンド開発以外にも、専門的な仕事ができる可能性がある。少なくとも社内でそうした職を持つ人にお近づきになれる
