...
* 概略
** 2021年
- テスト開発のリーダーとして、RSpecテスト強化、CI保守、各種テスト環境の整備を行った。(業務)
...
- Emacsのプロジェクト切り替えパッケージProjectileのバグを修正するPRを送った。https://github.com/bbatsov/projectile/pull/1700
** 2020年
...
** 2018年
- 村上龍にハマり、彼のすべての小説、エッセイを読んだ。イチオシは『5分後の世界』
** 2017年
- WordPressでサイトを運営していた。
** 2016年
- 鹿児島大学(法文学部経済情報学科)に入学した。
- 北京の清華大学に語学留学した(半年間)。
** 2015年
