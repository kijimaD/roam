...
#+begin_src shell :results raw
  ...
  echo $(cat <<EOF
  (save-excursion
    (while (re-search-backward "KDOC 202" nil t)
...
#+RESULTS:
#+begin_src
(save-excursion (while (re-search-backward "KDOC 202" nil t) (replace-match "KDOC 202")))
#+end_src
...
* 概要
# 本文(タイトルをつける)。
[[https://tatsu-zine.com/books/make-your-own-os-in30days][30日でできる! OS自作入門【委託】 - 達人出版会]]は、OS自作の本。
