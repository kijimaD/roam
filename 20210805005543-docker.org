...
#+caption: system specを実行する
#+begin_src shell
  sudo docker-compose -f docker-compose.yml -f docker-compose-app.override.yml run rails bundle exec rspec --options ./.rspec ./spec/system/user_spec.rb
#+end_src
*** DONE DBのGUIツールとの接続
