...
:mtime:    20250125215047
:ctime:    20210508234743
:END:
#+title: Emacs
* 概要
...
ほとんどは[[id:c7e81fac-9f8b-4538-9851-21d4ff3c2b08][Emacs Lisp]]で書かれている。コアな部分は[[id:656a0aa4-e5d3-416f-82d5-f909558d0639][C言語]]。
~src/*~ にはCのコードがある。
...
- サジェストまわりの設定
** DONE 補完まわりをちゃんとする
CLOSED: [2025-01-25 Sat 21:50]
:PROPERTIES:
:Effort:   6:00
:END:
:LOGBOOK:
CLOCK: [2025-01-25 Sat 15:27]--[2025-01-25 Sat 15:52] =>  0:25
:END:

うまく設定できていない。

- go-modeで補完が正しく出ない。見当はずれなのが出る
- lisp-modeでは出ている
- eglotを使うようにして、設定をいじって補完が出るようになった
